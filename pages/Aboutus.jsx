...
import Godwin from "../public/assets/Godwin1.jpeg"
...
const Aboutus = () => {
  return (
    <div >
      ...
      <div className='bg-white-400 text-sm   font-bold leading-7 w-5/6 mx-auto text-center my-9 '>
      ...
      <div className='bg-white text-Teal  md:flex justify-center items-center gap-[4rem] mx-auto p-[3rem] '>
        <div className='w-50 mx-auto'> 
          ...
          <Image src={Godwin} width = {400} height= {300} alt="" /> 
          </div>
        <div>
